...
/*积分商城商品*/
INSERT INTO `RTM`.`rtm_product_info`(`name`,`title`,`description`,`source`)
VALUES("君度橙酒两瓶","君度橙酒","1849年，君度酿酒厂在法国昂热诞生。我们的酿酒大师精心选用最上乘的甜味橙皮和苦味橙皮，运用传统的酿造技艺，创造出源自天然，晶莹剔透的高档橙味力娇酒——君度。从为君度量身定制的经典鸡尾酒——边车、玛格丽特和君度大都会，到极简主义的君度菲丝，君度一直是精致鸡尾酒的灵魂。君度搭配柠檬或者青柠汁可调制出多种经典鸡尾酒，同样，君度菲丝（君度+青柠+苏打水）是可以在家中轻松调配简易鸡尾酒的完美选择。君度菲丝是调制简易鸡尾酒的完美原料。在你的创意妙想下，君度菲丝将成为你独一无二的特制鸡尾酒，变换出无限可能。","法国");
INSERT INTO `RTM`.`rtm_product_info`(`name`,`title`,`description`,`source`)
...
INSERT INTO `RTM`.`rtm_product_info`(`name`,`title`,`description`,`source`)
VALUES("人头马天醇X.O特优香槟干邑礼盒","人头马天醇X.O特优香槟干邑礼盒","采用源自于干邑区最中心的大小香槟区的优质葡萄，成就了人头马天醇X.O特优香槟干邑独一无二的馥郁芳香，醇香丰盛，顺喉圆浑带来如丝般感觉。茉莉、鸢尾花、肉桂等花果香气如清风袭面，天鹅绒般饱满的醇香丰盈、顺喉、圆浑，带来飘飘欲仙的回甘。","法国");
INSERT INTO `RTM`.`rtm_product_info`(`name`,`title`,`description`,`source`)
