...
INSERT INTO `LP`.`lp_promotion_info` (`store_id`,`name`,`password`,`phone`,`email`,`wechat_id`,`status`,`last_login`) 
...
/*线下商品*/
INSERT INTO `LP`.`lp_product_info`(`name`,`title`,`description`,`source`)
...
/*线下商品*/
INSERT INTO `LP`.`lp_product_specification`(`product_id`,`spec_id`,`score`,`stock_num`,`exchange_num`,`is_for_exchange`,`status`)
...
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(1,"thumbnailurl1","bigimageurl1");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(2,"thumbnailurl2","bigimageurl2");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(3,"thumbnailurl3","bigimageurl3");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(4,"thumbnailurl4","bigimageurl4");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(5,"thumbnailurl5","bigimageurl5");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(6,"thumbnailurl6","bigimageurl6");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(7,"item1.png","item_l_1.png");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(8,"item2.png","img2.png");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(9,"item3.png","img3.png");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(10,"item4.png","img4.png");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(11,"item5.png","img5.png");
INSERT INTO `LP`.`lp_product_images`(`product_id`,`thumbnail_url`,`image_url`)VALUES(12,"item6.png","img6.png");
