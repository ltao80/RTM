<div class="main">
    ...
    <div class="detail_info">获得积分：<span><?php if(isset($score_info['order_type'])){if($score_info['order_type'] == "1"){echo "-";}else{echo "+";}}?><?php if(isset($score_info['total_score'])){echo $score_info['total_score'];}?></span></div>
</div>