<div class="main">
    ...
    <ul class="query_list">
        ...
        <li>
            ...
            <p>消耗积分<span><?php if(isset($score_info['order_type'])){if($score_info['order_type'] == "1"){echo "-";
            }else{echo "+";}}?><?php if(isset($score_info['total_score'])){echo $score_info['total_score'];}?>分</span></p>
