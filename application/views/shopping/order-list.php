<div class="main">
    <ul class="oders_list">
        ...
        <li>
            ...
            <?php foreach($order_info['product_list'] as $product_info){?>
            <div class="oders_main">
                <div class="confirm_img"><img src="/static/images/<?php if(isset($product_info['image_url'])){echo
            ...
            <?php } ?>
            <p>
                共<?php if(isset($order_info['product_list'])){echo count($order_info['product_list']);}?>件商品 <?php if(isset($order_info['total_score'])){echo $order_info['total_score'];}?>积分
