<div class="main">
    <div class="info_form">
        <form action="<?php echo base_url()?>/customer/update" id="info_form" method="POST">
            <p>姓名</p>
            ...
            <p>手机号码</p>
            <input type="tel" maxlength="11" name="info_tel" data-vv-validations="info_tel" value="<?php if(isset
            ($customer_info['phone'])){echo
