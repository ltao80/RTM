<div class="main">
    <div class="info_form">
        <form action="" id="info_form">
            ...
            <p>省</p>
            <input type="text" name="info_addr" value="<?php if(isset($customer_info['receiver_province'])){echo $customer_info['receiver_province'];}?>" class="required info_input" placeholder="省" />
            <p>市</p>
            <input type="text" name="info_addr" value="<?php if(isset($customer_info['receiver_city'])){echo $customer_info['receiver_city'];}?>" class="required info_input" placeholder="市" />
            <p>区</p>
            <input type="text" name="info_addr" value="<?php if(isset($customer_info['receiver_region'])){echo $customer_info['receiver_region'];}?>" class="required info_input" placeholder="区" />
            <p>详细地址</p>
