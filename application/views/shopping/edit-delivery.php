<div class="main">
    <div class="info_form">
        <form action="" id="info_form">
            ...
            <p>省</p>
            <input type="text" name="info_province" value="<?php if(isset($delivery_info['receiver_province'])){echo $delivery_info['receiver_province'];}?>" class="required info_input" placeholder="省" />
            <p>市</p>
            <input type="text" name="info_city" value="<?php if(isset($delivery_info['receiver_city'])){echo $delivery_info['receiver_city'];}?>" class="required info_input" placeholder="市" />
            <p>区</p>
            <input type="text" name="info_region" value="<?php if(isset($delivery_info['receiver_region'])){echo $delivery_info['receiver_region'];}?>" class="required info_input" placeholder="区" />
            <p>详细地址</p>
