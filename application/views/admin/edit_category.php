    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div id="dashboard">
                ...
                <div class="row-fluid">
                    <form class="form-horizontal" id="PG_form" action="/admin/product_manage/edit_category?category_id=<?php echo $data['id']?>" method="post" enctype="multipart/form-data">
                        <div class="portlet-body">
                            <div class="control-group">
                                <label class="control-label my_color_red">请输入类别名称：</label>
                                <div class="controls">
                                    <input type="text" class="span6 m-wrap" placeholder="角色名称" name="category_name" value="<?php echo $data['name']?>"/>
